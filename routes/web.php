...
/* Display the edit form for a specific firefighter */
...
| Web Routes
|--------------------------------------------------------------------------
| These routes handle all Type Vehicle CRUD operations.
| Each route points to a specific controller method.
*/
...
Route::get('/TypeVehicles/{id}/edit', [TypeVehicleController::class, 'formModifyTypeVehicle'])->name('typeVehicle.edit');

/* Update a specific  type vehicle */
Route::put('/typeVehicles/{id}/update', [TypeVehicleController::class, 'update'])->name('typeVehicle.update');
...
Route::delete('/vehicles/clear', [VehicleController::class, 'clear'])->name('Vehicle.clear');
